...
emp <- read_delim("simulations_data/sumst_ZI_in2rmal_overall_noncoding.txt", 
...
acc <- read_delim("simulations_data/posterior_10ksamples_noncoding_allsnps.txt",
                    " ", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE,comment = "#")
colnames(acc) = c("t", "pi.m", "pi.sd", "s.m", "s.sd" ,"tajD.m", "TajD.sd")

rej <- read_delim("simulations_data/rejected_noncoding_allsnps.txt",
                  " ", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE,comment = "#")
