...
emp <- read_delim("sims_10kacc_noshared_in2rmal_overall/sumst_ZI_in2rmal_overall_noshared.txt", 
...
acc <- read_delim("sims_10kacc_noshared_in2rmal_overall/sims_tol005_nosharedsnps_posterior.txt",
                    " ", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE,comment = "#")
colnames(acc) = c("t", "pi.m", "pi.sd", "s.m", "s.sd" ,"tajD.m", "TajD.sd")

rej <- read_delim("sims_10kacc_noshared_in2rmal_overall/sims_tol005_nosharedsnps_rejected.txt",
                  " ", escape_double = FALSE, col_names = FALSE, trim_ws = TRUE,comment = "#")
...
##############Goodness of fit
gof <- read_delim("sims_10kacc_noshared_in2rmal_overall/gof_sim_2228_0.073657_testing.txt", 
                  " ", escape_double = FALSE, col_names = FALSE, 
